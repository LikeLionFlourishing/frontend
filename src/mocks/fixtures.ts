...
export const reportOptions: SkinReportOptions = {
   ...
   */
  appearances: [
    { value: 'APP_REDNESS', label: '붉어짐' },
    { value: 'APP_BUMP', label: '돌기와 울퉁불퉁함' },
    { value: 'APP_PUS_BUMP', label: '고름이 찬 돌기' },
    { value: 'APP_DRYNESS', label: '각질/건조' },
    { value: 'APP_OILINESS', label: '번들거림/유분' },
    { value: 'APP_OTHER', label: '기타' },
  ],
