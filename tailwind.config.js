    ...
    extend: {
      colors: {
        ...
        guide: {
          ...
          avoid: '#90C3C9',
          next: '#346EFF',
          // 2026-08-16 개편에서 카드가 6장이 되며 뒤 두 장의 색이 바뀌었다.
          // 남색 하나였던 자리가 민트(유사 기록) + 연한 파랑(추천 성분)으로 갈렸다.
          similar: '#9DF2E4',
          ingredient: '#A6C5FF',
        },
      ...
      boxShadow: {
        /*
         * 시안의 카드 입체감. 바깥으로 드리우는 그림자가 아니라 **안쪽** 그림자다.
         * 왼쪽 위에서 어둡게, 오른쪽 아래에서 밝게 들어와 눌린 것처럼 보인다.
         *
         * 실측(홈 25:28596 렌더 픽셀): 바탕이 F 일 때
         *   테두리 1px  F+8~12
         *   위·왼쪽    가장자리 F-6 에서 13px 에 걸쳐 F 로
         *   아래·오른쪽 가장자리에서 13px 에 걸쳐 F+6 으로
         *
         * 진한 회색 패널(#D5D5D5)과 강조색 타일에는 시안에도 없다. 밝은 카드에만 쓴다.
         */
        neu: [
